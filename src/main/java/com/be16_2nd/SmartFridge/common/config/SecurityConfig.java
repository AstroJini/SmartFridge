...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                ...
                .authorizeHttpRequests(a->a.requestMatchers("/api/v1/email/send", "/api/v1/email/verify", "/member/forgot-password/send-code", "/member/forgot-password/verify-code","/member/forgot-password/updatepw", "/member/create", "/member/doLogin", "/member/google/doLogin", "/member/kakao/doLogin", "/member/naver/doLogin", "connect/chat/**","/api/enums").permitAll().anyRequest().authenticated())
